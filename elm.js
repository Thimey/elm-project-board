...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SetTitleInput":["Int","String"],"AddWidget":["Main.Widget"],"SetContentInput":["Int","String"],"AddCategory":["Main.Category"],"SetCategoryInput":["String"]}}},"aliases":{"Main.Category":{"args":[],"type":"{ id : Int , label : String , titleInput : String , contentInput : String }"},"Main.Widget":{"args":[],"type":"{ id : Int, category : Int, title : String, content : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
